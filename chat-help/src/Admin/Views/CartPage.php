        ...
        Chat_Help::createSection($prefix, array(
            ...
            'fields'      => array(
                ...
                array(
                    ...
                    'dependency' =>  array('cart_page_button|cart_page_button_type_of_whatsapp', '==|==', 'true|number', 'any'),
                ),
                array(
                    'id' => 'cart_page_button_group',
                    'type' => 'text',
                    ...
                    'dependency' =>  array('cart_page_button|cart_page_button_type_of_whatsapp', '==|==', 'true|group', 'visible'),
                ),
                array(
                ...
                array(
                    ...
                    'desc' => '<b>' . esc_html__('WooCommerce Vars:', 'chat-help') . '</b> {cartInfo} <br>' . '<b>' . esc_html__('Global Vars:', 'chat-help') . '</b> {siteTitle}, {siteEmail}, {currentURL}, {currentTitle}, {siteURL}, {ip}, {date}',
                ...
                array(
                    ...
                    'type' => 'switcher',
                    'class' => 'chat_help_number',
                    'title' => esc_html__('Hide default Checkout Button', 'chat-help'),
                    'chat-help',
                ...
                array(
                    ...
                    'default' => esc_html__('Complete Order via WhatsApp', 'chat-help'),
