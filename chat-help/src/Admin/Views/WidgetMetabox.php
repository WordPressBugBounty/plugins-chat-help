 ...
 *
 * @package chat-help
 * @subpackage chat-help/src/Admin/Views/WidgetMetabox
 * @author     ThemeAtelier<themeatelierbd@gmail.com>
 */

namespace ThemeAtelier\ChatHelp\Admin\Views;

use ThemeAtelier\ChatHelp\Admin\Views\WidgetOptions;
...
class WidgetMetabox
{
    ...
    public static function options($prefix)
    {
        ...
        SchemaRegistry::createMetabox($prefix, array(
            'title'         => esc_html__('Chat Help Options', 'chat-help'),
            'post_type'     => array('floating_widget'),
            'framework_title'   => esc_html__('Chat Help', 'chat-help'),
            'theme'         => 'light',
            'nav'           => 'inline',
            'show_restore'  => false,
            'context'       => 'normal',
        ...
        WidgetOptions::options($prefix, $timezones);
    }
}
