 ...
 *
 * @package chat-help
 * @subpackage chat-help/src/Admin/Views/ThankYouPage
    ...
    public static function options($prefix)
    {
        SchemaRegistry::createSection($prefix, array(
            ...
            'fields'      => array(
                ...
                WhatsAppFields::number('thank_you_page_button_number', array(
                    array('thank_you_page_button_type_of_whatsapp', '==', 'number', 'any'),
                    array('thank_you_page_button', '==', 'true'),
                )),
                WhatsAppFields::group('thank_you_page_button_group', array(
                ...
                array(
                    ...
                    'title_help' => '<div class="chat-help-img-tag"><img src="' . esc_url(CHAT_HELP_DIR_URL . 'src/Admin/assets/images/preview/button_text.png') . '" alt=""></div>' . '<div class="chat-help-info-label">' . esc_html__('Enter custom subtitle. e.g. For faster response, send your order details by clicking below button.', 'chat-help') . '</div>' . ' <a class="tooltip_btn_primary" target="_blank" href="' . CHAT_HELP_DEMO_URL . 'simple-button/">' . esc_html__('Live Demo', 'chat-help') . '</a>' . ' <a class="tooltip_btn_secondary" target="_blank" href="' . CHAT_HELP_DEMO_URL . 'docs/woocommerce-button/?ref=1">' . esc_html__('Open Docs', 'chat-help') . '</a>',
