 ...
 *
 * @package chat-help
 * @subpackage chat-help/src/Admin/Views/ProductPage
    ...
    public static function options($prefix)
    {
        ...
        Chat_Help::createSection($prefix, array(
            ...
            'fields'      => array(
                ...
                array(
                    'id' => 'product_page_button_type_of_whatsapp',
                    'type' => 'radio',
                    'inline' => true,
                ...
                array(
                    ...
                    'dependency' =>  array(
                        array('product_page_button_type_of_whatsapp',   '==', 'number', 'visible'),
                        array('product_page_button', '==', 'true'),
                    ),
                ),
                ...
                array(
                    ...
                    'dependency' => array('product_page_button|product_page_button_style|product_page_button_icon_open', '==|!=|!=', 'true|10|no_icon', 'any'),
                ),
                array(
                    'id' => 'product_page_icon_bg',
                    'type' => 'switcher',
                ...
                array(
                    ...
                    'dependency' => array('product_page_button|product_page_button_icon_open|product_page_button_style|product_page_icon_bg', '==|!=|==|==', 'true|no_icon|2|true', 'any'),
                ),
                ...
                array(
                    ...
                    'dependency' => array('product_page_button|opt-button-style', '==|!=', 'true|1', 'any'),
                ),
                array(
                ...
                array(
                    'id'      => 'product_page_button_visibility',
                    'type'    => 'button_set',
