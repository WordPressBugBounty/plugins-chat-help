...
class Insights {
    ...
    public function admin_notice() {
        ...
        echo '<div class="updated"><p>';
            ...
            echo '&nbsp;<a href="' . esc_url( $optin_url ) . '" class="button-primary button-large">' . $this->client->chat_help_trans( 'Allow' ) . '</a>';
            echo '&nbsp;<a href="' . esc_url( $optout_url ) . '" class="button-secondary button-large">' . $this->client->chat_help_trans( 'No thanks' ) . '</a>';
        echo '</p></div>';
